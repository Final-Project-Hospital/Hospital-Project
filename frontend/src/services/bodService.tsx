...
import { BodcenterInterface,DeleteBODInterface } from "../interface/IBodCenter";
...
export const GetBeforeAfterBOD = async (
): Promise<any | null> => {
  try {
    const response = await axios.get(`${apiUrl}/get-beforeafter-bod`,{
      headers: {
        "Content-Type": "application/json",
        ...getAuthHeader(),
      },
