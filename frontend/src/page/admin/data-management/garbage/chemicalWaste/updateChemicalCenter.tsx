...
import { UpdateOrCreateChemical } from '../../../../../services/garbageServices/chemicalWaste';
import { ListUnitInterface } from '../../../../../interface/IUnit';

const { Option } = Select;

interface UpdateChemicalCentralFormProps {
    initialValues: any; // รับค่า before/after 2 record
    onSuccess?: () => void;
    onCancel: () => void;
}

const UpdateChemicalCentralForm: React.FC<UpdateChemicalCentralFormProps> = ({
    initialValues,
    onSuccess,
    onCancel
}) => {
...
export default UpdateChemicalCentralForm;