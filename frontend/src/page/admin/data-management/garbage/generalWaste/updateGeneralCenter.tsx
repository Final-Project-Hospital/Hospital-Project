...
const UpdateGeneralCentralForm: React.FC<UpdateGeneralCentralFormProps> = ({
    ...
    useEffect(() => {
        ...
        const fetchInitialData = async () => {
            const [beforeAfter, units, targetsMiddle, targetsRange] = await Promise.all([
                ListBeforeAfterTreatment(),
                ListUnit(),
                ListMiddleTarget(),
                ListRangeTarget()
    ...
    const handleFinish = async (values: any) => {
        try {
            ...
            const hasCustomSingle = targetType === "middle" && useCustomTarget && values.customSingle !== undefined;
            const hasCustomRange = targetType === "range" && useCustomTarget && values.customMin !== undefined && values.customMax !== undefined;
            ...
            console.error("Error updating Garbage:", error?.response?.data || error);
