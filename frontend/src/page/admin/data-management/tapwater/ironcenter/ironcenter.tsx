...
const { Option } = Select;
const IRONCentralForm: React.FC<Props> = ({ onCancel, onSuccess }) => {
    ...
    const GetfirstrowIRON = async () => {
        try {
            const responfirstIRON = await GetfirstIRON();
            if (responfirstIRON.status === 200) {
                const data = responfirstIRON.data;
                ...
                message.error("ไม่สามารถดึงข้อมูลการนัดหมายได้ สถานะ: " + responfirstIRON.status);
            }
        } catch (error) {
    ...
    const handleFinish = async (values: any) => {
        ...
        if (selectedTreatmentID === 3) {
            ...
            const payloadBefore: IRONcenterInterface = {
            ...
            const payloadAfter: IRONcenterInterface = {
                Date: combinedDateTime.toISOString(),
            ...
            const res1 = await createIRON(payloadBefore);
            ...
            const ironData: IRONcenterInterface = {
                Date: combinedDateTime.toISOString(),
                Data: values.data,
                Note: values.note,
            ...
            const response = await createIRON(ironData);
        ...
        <div>
            ...
            <div className="iron-container">
                ...
                >
                    ...
                    <div className="iron-form-group">
                        ...
                        <div className="iron-from-mini">
                            ...
                            <div style={{ position: 'relative', top: '-15px' }}>
                                ...
                                {standardType === 'range' && useCustomStandard && (
                                    <div className="iron-fornt-small">
                                        <Form.Item
                                            label="ค่าต่ำสุด (Min)"
                                            name="customMin"
                    ...
                    <Form.Item className="iron-form-actions" >
                        <Button className="iron-cancel" htmlType="button" onClick={handleCancelClick} >
                            ยกเลิก
                        </Button>
                        <Button htmlType="reset" className="iron-reset" onClick={handleClear} >
                            รีเซ็ต
                        </Button>
                        <Button type="primary" htmlType="submit" className="iron-submit">
                            บันทึก
                        </Button>
                    </Form.Item>
                </Form>
...
export default IRONCentralForm;
