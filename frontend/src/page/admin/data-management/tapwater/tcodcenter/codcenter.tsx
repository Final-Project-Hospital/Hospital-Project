...
import { CreateTCOD, GetfirstTCOD } from "../../../../../services/tapwater";
...
import { CreateTCODInterface } from "../../../../../interface/ITapwater";
...
const TKNCenterForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const GetfirstrowTKN = async () => {
      try {
        const responfirstTKN = await GetfirstTCOD();
  ...
  const handleFinish = async (values: any) => {
    try{
        ...
        if (selectedTreatmentID === 3) {
          ...
          const payloadBefore: CreateTCODInterface = {
          ...
          const payloadAfter: CreateTCODInterface = {
              Date: combinedDate.toISOString(),
          ...
          const payload: CreateTCODInterface = {
              Date: combinedDate.toISOString(),
              Data: values.data,
          ...
          const res = await CreateTCOD(payload);
