...
import { UpdateOrCreateTCOD, DeleteTCOD } from '../../../../../services/tapwaterServices/tcod';
    ...
    const handleFinish = async (values: any) => {
        try {
            ...
            if (values.beforeAfterTreatmentID === 3) {
                ...
                const res = await UpdateOrCreateTCOD(beforePayload);
                ...
                await UpdateOrCreateTCOD(afterPayload);

            } else if (values.beforeAfterTreatmentID === 1) {
                await UpdateOrCreateTCOD({
                    ...basePayload,
                    ID: initialValues[0]?.ID ?? null,
