...
import { CreateEcoli, GetfirstEcoli } from "../../../../../services/drinkwater";
...
import { CreateEcoliInterface } from "../../../../../interface/IDrinkwater";
...
const TKNCenterForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const GetfirstrowTKN = async () => {
      try {
        const responfirstTKN = await GetfirstEcoli();
  ...
  const handleFinish = async (values: any) => {
    try{
        ...
        if (selectedTreatmentID === 3) {
          ...
          const payloadBefore: CreateEcoliInterface = {
          ...
          const payloadAfter: CreateEcoliInterface = {
              Date: combinedDate.toISOString(),
          ...
          const res1 = await CreateEcoli(payloadBefore);
          const res2 = await CreateEcoli(payloadAfter);
          ...
          const payload: CreateEcoliInterface = {
              Date: combinedDate.toISOString(),
              Data: values.data,
          ...
          const res = await CreateEcoli(payload);
      ...
      <div className="eco-container">
        ...
        >
          ...
          <Form.Item className="eco-form-actions">
              ...
              <Button className="eco-cancel" htmlType="button">
                ยกเลิก
              </Button>
              <Button htmlType="reset" className="eco-reset" onClick={handleCancel}>
                รีเซ็ต
              </Button>
