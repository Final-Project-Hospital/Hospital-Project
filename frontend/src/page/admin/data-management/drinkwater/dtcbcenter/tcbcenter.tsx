...
import { CreateTCB, GetfirstTCB } from "../../../../../services/drinkwater";
...
import { CreateDTCBInterface } from "../../../../../interface/drinkwater";
  ...
  const handleFinish = async (values: any) => {
    try{
        ...
        if (selectedTreatmentID === 3) {
          ...
          const payloadBefore: CreateDTCBInterface = {
          ...
          const payloadAfter: CreateDTCBInterface = {
              Date: combinedDate.toISOString(),
          ...
          const payload: CreateDTCBInterface = {
              Date: combinedDate.toISOString(),
              Data: values.data,
