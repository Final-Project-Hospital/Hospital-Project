...
import { DTCBcenterInterface } from '../../../../../interface/Idrinkwater/Idtcb';
...
import { GetfirstDTCB, createDTCB } from '../../../../../services/drinkwaterServices/dtcb';
    ...
    const handleFinish = async (values: any) => {
        ...
        if (selectedTreatmentID === 3) {
            ...
            if (response.status === 201) {
                messageApi.open({
                    type: 'success',
                    content: 'การบันทึกข้อมูล DTCB สำเร็จ',
                });
                form.resetFields();
                setIsOtherunitSelected(false);
                setUseCustomStandard(false);
