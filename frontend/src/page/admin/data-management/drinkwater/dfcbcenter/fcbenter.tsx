...
import { CreateFCB, GetfirstFCB } from "../../../../../services/drinkwater";
...
import { CreateDFCBInterface } from "../../../../../interface/IDrinkwater";
...
const FCBCenterForm: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const GetfirstrowTKN = async () => {
      try {
        const responfirstTKN = await GetfirstFCB();
  ...
  const handleFinish = async (values: any) => {
    try{
        ...
        if (selectedTreatmentID === 3) {
          ...
          const payloadBefore: CreateDFCBInterface = {
          ...
          const payloadAfter: CreateDFCBInterface = {
              Date: combinedDate.toISOString(),
          ...
          const payload: CreateDFCBInterface = {
              Date: combinedDate.toISOString(),
              Data: values.data,
