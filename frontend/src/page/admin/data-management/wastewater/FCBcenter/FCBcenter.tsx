...
import { FCBcenterInterface } from '../../../../../interface/Iwastewater/Ifcb';
...
import { GetfirstFCB, createFCB } from '../../../../../services/wastewaterServices/fcb';
...
const { Option } = Select;
const FCBCentralForm: React.FC<Props> = ({ onCancel, onSuccess }) => {
    ...
    const GetfirstrowFCB = async () => {
        try {
            ...
            if (responfirstFCB.status === 200) {
                ...
                message.error("ไม่สามารถดึงข้อมูลการนัดหมายได้ สถานะ: " + responfirstFCB.status);
            }
        } catch (error) {
    ...
    const handleFinish = async (values: any) => {
        ...
        if (selectedTreatmentID === 3) {
            ...
            const payloadBefore: FCBcenterInterface = {
            ...
            const payloadAfter: FCBcenterInterface = {
                Date: combinedDateTime.toISOString(),
            ...
            const fcbData: FCBcenterInterface = {
                Date: combinedDateTime.toISOString(),
                Data: values.data,
                Note: values.note,
            ...
            const response = await createFCB(fcbData);
            console.log(fcbData);
            ...
            <div className="fcb-container">
                ...
                >
                    ...
                    <Form.Item className="fcb-form-actions" >
                        <Button className="fcb-cancel" htmlType="button" onClick={handleCancelClick} >
                            ยกเลิก
                        </Button>
                        <Button htmlType="reset" className="fcb-reset" onClick={handleClear} >
                            รีเซ็ต
                        </Button>
