...
import { TCBcenterInterface } from '../../../../../interface/Iwastewater/Itcb';
...
import { GetfirstTCB, createTCB } from '../../../../../services/wastewaterServices/tcb';
...
const { Option } = Select;
const TCBCentralForm: React.FC<Props> = ({ onCancel, onSuccess }) => {
    ...
    const GetfirstrowTCB = async () => {
        try {
            ...
            if (responfirstTCB.status === 200) {
                ...
                message.error("ไม่สามารถดึงข้อมูลการนัดหมายได้ สถานะ: " + responfirstTCB.status);
            }
        } catch (error) {
    ...
    const handleFinish = async (values: any) => {
        ...
        if (selectedTreatmentID === 3) {
            ...
            const payloadBefore: TCBcenterInterface = {
            ...
            const payloadAfter: TCBcenterInterface = {
                Date: combinedDateTime.toISOString(),
            ...
            const tcbData: TCBcenterInterface = {
                Date: combinedDateTime.toISOString(),
                Data: values.data,
                Note: values.note,
            ...
            const response = await createTCB(tcbData);
            console.log(tcbData);
            ...
            <div className="tcb-container">
                ...
                >
                    ...
                    <Form.Item className="tcb-form-actions" >
                        <Button className="tcb-cancel" htmlType="button" onClick={handleCancelClick} >
                            ยกเลิก
                        </Button>
                        <Button htmlType="reset" className="tcb-reset" onClick={handleClear} >
                            รีเซ็ต
                        </Button>
