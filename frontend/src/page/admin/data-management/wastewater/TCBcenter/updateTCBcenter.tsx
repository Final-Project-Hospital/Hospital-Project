...
import { UpdateOrCreateTCB, DeleteTCB } from '../../../../../services/wastewaterServices/tcb';
...
interface UpdateTCBCentralFormProps {
    initialValues: any; // รับค่า before/after 2 record
    onSuccess?: () => void;
    onCancel: () => void;
}

const UpdateTCBCentralForm: React.FC<UpdateTCBCentralFormProps> = ({
    initialValues,
    onSuccess,
    onCancel
}) => {
    ...
    const handleFinish = async (values: any) => {
        try {
            ...
            if (values.beforeAfterTreatmentID === 3) {
                ...
                const res = await UpdateOrCreateTCB(beforePayload);
                ...
                await UpdateOrCreateTCB(afterPayload);
            ...
            console.error("Error updating TCB:", error?.response?.data || error);
...
export default UpdateTCBCentralForm;