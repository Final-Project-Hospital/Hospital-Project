...
const { Option } = Select;
const CODCentralForm: React.FC<Props> = ({ onCancel, onSuccess }) => {
    ...
    const GetfirstrowCOD = async () => {
        try {
            ...
            if (responfirstCOD.status === 200) {
                ...
                message.error("ไม่สามารถดึงข้อมูลการนัดหมายได้ สถานะ: " + responfirstCOD.status);
            }
        } catch (error) {
            ...
            <div className="cod-container">
                ...
                >
                    ...
                    <Form.Item className="cod-form-actions" >
                        <Button className="cod-cancel" htmlType="button" onClick={handleCancelClick} >
                            ยกเลิก
                        </Button>
                        <Button htmlType="reset" className="cod-reset" onClick={handleClear} >
                            รีเซ็ต
                        </Button>
