...
import BarChartingImg from "../../../../../../assets/chart/BarCharting.png";
...
const graphImages = [
  ...
  { id: 3, name: "Bar", img: BarChartingImg },
  { id: 4, name: "Color Mapping", img: MappingImg },
  { id: 5, name: "Stacked", img: StackChartingImg },
];
...
const EditParameterModal: React.FC<EditParameterModalProps> = ({
  ...
  const graphRows = [
    graphImages.slice(0, 3),
    graphImages.slice(3, 5),
  ];
